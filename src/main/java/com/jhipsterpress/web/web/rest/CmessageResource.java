...
public class CmessageResource {
    ...
    */
    ...
    /**
     * SEARCH  /_search/cmessages?query=:query : search for the cmessage corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<CmessageDTO>> searchCmessages(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/cmessages");
