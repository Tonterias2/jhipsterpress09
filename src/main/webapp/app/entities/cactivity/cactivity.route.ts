...
export class CactivityResolve implements Resolve<ICactivity> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Cactivity> {
