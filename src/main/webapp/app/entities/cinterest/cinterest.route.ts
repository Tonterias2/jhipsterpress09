...
export class CinterestResolve implements Resolve<ICinterest> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Cinterest> {
